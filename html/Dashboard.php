...
<!DOCTYPE html>
<html>
<!-- <a href="ltr/login.php">Link</a> -->

<head>

    <!-- Title -->
    <title>Modern | Admin Dashboard Tempassetslate</title>
...
<body class="page-header-fixed">
    ...
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s1">
        ...
        <div class="slimscroll">
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar2.png" alt=""><span>Sandra
                    smith<small>Hi! How're you?</small></span></a>
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar3.png" alt=""><span>Amily
                    Lee<small>Hi! How're you?</small></span></a>
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar4.png"
            ...
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar5.png" alt=""><span>Nick
                    Doe<small>Hi! How're you?</small></span></a>
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar2.png" alt=""><span>Sandra
                    smith<small>Hi! How're you?</small></span></a>
            <a href="javascript:void(0);" class="showRight2"><img src="assets/images/avatar3.png" alt=""><span>Amily
                    Lee<small>Hi! How're you?</small></span></a>
    ...
    <div class="menu-wrap">
        <nav class="profile-menu">
            <div class="profile"><img src="assets/images/profile-menu-image.png" width="60"
    ...
    <main class="page-content content-wrap">
        ...
        <div class="page-inner">
            ...
            <?php
            $fetch_total = "select * from client_master";
            $run_query = mysqli_query($con, $fetch_total);
            $total_client = mysqli_num_rows($run_query);
            ?>
            <div id="main-wrapper">
                <div class="row">
                        ...
                        <div class="panel info-box panel-white">
                            <div class="panel-body">
                                <div class="info-box-stats">
                                    ...
                                    <span class="info-box-title">Total Outstanding</span>
                                </div>
                                <div class="info-box-icon">
                                    <i class="icon-eye"></i>
                                </div>
                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="stats-info">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">Servise Stats</h4>
                                        </div>
                                        <div class="panel-body">
                                            <ul class="list-unstyled">
                                                <li>DSC<div class="text-success pull-right">32%<i
                                                            class="fa fa-level-up"></i></div>
                                                </li>
                                                <li>PAN<div class="text-success pull-right">25%<i
                                                            class="fa fa-level-up"></i></div>
                                                </li>
                                                <li>TENDER<div class="text-success pull-right">16%<i
                                                            class="fa fa-level-up"></i></div>
                                                </li>
                                                <li>GST<div class="text-danger pull-right">13%<i
                                                            class="fa fa-level-down"></i></div>
                                                </li>
                                                <li>Other Servises<div class="text-danger pull-right">7%<i
                                                            class="fa fa-level-down"></i></div>
                                                </li>
                                                <!-- <li>Mobile &amp; tablet<div class="text-success pull-right">4%<i
                                                            class="fa fa-level-up"></i></div>
                                                </li>
                                                <li>Others<div class="text-success pull-right">3%<i
                                                            class="fa fa-level-up"></i></div>
                                                </li> -->
                                            </ul>
                                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-white" style="height: 60%;">
                            <div class="panel-heading">
                                <h4 class="panel-title">Server Load</h4>
                                <div class="panel-control">
                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                        title="Expand/Collapse" class="panel-collapse"><i
                                            class="icon-arrow-down"></i></a>
                                    <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                        title="Reload" class="panel-reload"><i class="icon-reload"></i></a>
                                </div>
                            </div>
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="weather-top">
                                                ...
                                                <h2 class="weather-day pull-right">Miami, FL<br><small><b>13th April,
                                                            2015</b></small></h2>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="panel twitter-box">
                            <div class="panel-body">
                                <div class="live-tile" data-mode="flip" data-speed="750" data-delay="3000">
                                    ...
                                    <div>
                                        <h2 class="no-m">It’s kind of fun to do the impossible...</h2><span
                                            class="tile-date">10 April, 2015</span>
                                    </div>
                                    <div>
                                        <h2 class="no-m">Sometimes by losing a battle you find a new way to win the
                                            war...</h2><span class="tile-date">6 April, 2015</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel facebook-box">
                            <div class="panel-body">
                                <div class="live-tile" data-mode="carousel" data-direction="horizontal" data-speed="750"
                                    ...
                                    <div>
                                        <h2 class="no-m">If you're going through hell, keep going...</h2><span
                                            class="tile-date">23 March, 2015</span>
                                    </div>
                                    <div>
                                        <h2 class="no-m">To improve is to change; to be perfect is to change often...
                                        </h2><span class="tile-date">15 March, 2015</span>
                                    </div>
                                </div>
                            </div>
                        </div>
